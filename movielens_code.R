...
##########################################################
# Create test set and training set. Unfortunately the original 
# code to create both datasets did not run in my computer, so
# the EdX team provided me with a more suitable way to obtain
# these datasets. It does not affect the rest of the process
# and the results are the same. Thank you, reader, for your
# understanding
##########################################################
